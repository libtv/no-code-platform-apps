...
import { method_post } from "./application.post";
import { method_get } from "./application.get";
import { method_del } from "./application.del";
import { method_patch } from "./application.patch";
